...
namespace ManishJoy\CreditPay\Setup;
...
class InstallData implements InstallDataInterface
{
     ...
     */
    const ORDER_STATUS_PROCESSING_FULFILLMENT_CODE = 'processing_credit';

    /**
     * Custom Processing Order-Status label
     */
    const ORDER_STATUS_PROCESSING_FULFILLMENT_LABEL = 'Processing Credit';

    /**
     * Custom Order-State code
     */
    const ORDER_STATE_CREDIT_CODE = 'credit_state';

    /**
     * Custom Order-Status code
     */
    const ORDER_STATUS_CREDIT_CODE = 'credit_status';

    /**
     * Custom Order-Status label
     */
    const ORDER_STATUS_CREDIT_LABEL = 'Credit';
    ...
    protected function addNewOrderStateAndStatus()
    {
        ...
        $status = $this->statusFactory->create();
        $status->setData([
            'status' => self::ORDER_STATUS_CREDIT_CODE,
            'label' => self::ORDER_STATUS_CREDIT_LABEL,
        ]);
        ...
        $status->assignState(self::ORDER_STATE_CREDIT_CODE, true, true);
    }
}